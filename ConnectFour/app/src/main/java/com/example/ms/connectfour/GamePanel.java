...
public class GamePanel extends ScrollView
{
	...
	public int [][] history;
	public int _size = 0;
	private LinearLayout.LayoutParams cell_param = new LinearLayout.LayoutParams(100, ViewGroup.LayoutParams.WRAP_CONTENT);
	...
	public void refreshMap()
	{
		...
		history = new int[parent._size * parent._size][Y_X];
		setCoordinateX(0);
		setCoordinateY(ConnectFour._size - 1);
		this._size = 0;
		parent._turn = true;
		parent.switchTurn();
	}//end of refreshMap
	...
	private void createArea()
	{
		...
		for(int i = 0; i < parent._size; ++i)
		{
			...
			for(int j = 0; j < parent._size; ++j)
			{
				...
				holder.addView(_map[i][j], cell_param);                                 //Add buttons to game panel.
			}
		}
	}//end of createArea
